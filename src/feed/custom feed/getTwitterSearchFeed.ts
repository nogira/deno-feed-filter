...
TODO: SEEMS TO EXCLUDE SOME TWEETS (perhaps twitter shadowbanning?). GETTING 
DIRECT FROM PROFILE MIGHT BE ONLY SOLUTION. THUS MIGHT BE FORCED TO CALL A 
SHIT-TONNE, SO PERHAPS VARY THE UPDATE FREQUENCY OF EACH TWITTER FEED BASED ON 
THE AVERAGE TWEETS PER DAY
